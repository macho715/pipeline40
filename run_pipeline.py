...
# -*- coding: utf-8 -*-
"""
HVDC 파이프라인 통합 실행 스크립트 v4.0.17
HVDC Pipeline Integrated Execution Script v4.0.17 - Stage 3 벡터화 최적화

전체 파이프라인을 하나의 명령으로 실행할 수 있는 통합 스크립트입니다.
Stage 4: Balanced Boost Edition - ML 위험도 정규화 및 혼합 위험도 시스템
"""
...
def print_banner():
    """파이프라인 시작 배너를 출력합니다."""
    print("\n" + "=" * 80)
    print("HVDC PIPELINE v4.0.17 - Stage 3 벡터화 최적화")
        ...
        if stage_num == 1:
            ...
            if getattr(args, "no_sorting", False):
                ...
                if use_v30:
                    ...
                    print(f"INFO: Using v3.0 (semantic matching) - output: {output_path}")
                else:
